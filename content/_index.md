...
data scientist and for [Civic Hall](http://civichall.org) as a research intern. In the past, I've worked for UChicago's [IOP](http://politics.uchicago.edu), [AAPI Data](http://aapidata.com), [VestHQ](http://vesthq.com), and the [IPE Lab](http://home.uchicago.edu/~gulotty/IPElab.html). I TA'd for [Computing for the Social Sciences](http://cfss.uchicago.edu) in Spring 2019, and will be helping to revamp the curriculum in Winter 2020. 
